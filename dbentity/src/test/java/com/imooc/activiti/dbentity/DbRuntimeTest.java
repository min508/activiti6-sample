...
public class DbRuntimeTest {
    ...
    public static final Logger LOGGER = LoggerFactory.getLogger(DbRuntimeTest.class);
    ...
    public void testRuntime(){
        activitiRule.getRepositoryService().createDeployment()
                ...
                .deploy();
        Map<String, Object> variabels = Maps.newHashMap();
        variabels.put("key1", "value1");
        ProcessInstance processInstance = activitiRule.getRuntimeService()
                .startProcessInstanceByKey("second_approve",variabels);
    }
